...
public class Assign1 {
     ...
     * @return
     */
    private static Aircraft getAirCraftByNum(String num)
    {
     ...
     */
    public static boolean assign1(String airport, long assignTime)
    {
            ...
            for (Flight flight : flightLine.flightLine) {
                ...
                if (flight.actualAircraftType.equals("9")){
                    ...
                    if ((finFlight.actualLandingTime < (assignTime - 45*60)) && (finFlight.landingAirport.equals(airport))){
                        if (!finFlight.actualAircraftNum.equals(null)){
                    ...
                    if ((flight.actualDepartureTime > assignTime) && (flight.departureAirport.equals(airport))){
                        if (!flight.actualAircraftNum.equals(null)){
...
//                    flight.actualLandingTime = -1;
                        flight.actualAircraftType = null;
                        flight.actualAircraftNum = null;
                        flight.delayTime = -1;
                    }
                }
                else {
...
//                            aircraft.flight = firstFlight;
                        ...
                        if (replaceLine.flightLine.size() > 0){
